...
const sayHello = () => {
    axios.get('http://localhost:3000/say-hello').then((res) => {
        ...
        helloText.style.backgroundColor = 'pink';
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/dgdfsghdfhsfdh')
    .then(res => {
        console.log(res.data)
...
/* 
    ...
    Write a functionthat makes a get request to 'http://localhost:3000/query-test', with a query of your choice on the end!
...
axios.get('http://localhost:3000/query-test?banana-yogurt')
